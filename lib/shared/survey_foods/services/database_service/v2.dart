...
class DatabaseService {
  ...
  final String _nameNutrientsColumnNameFavorites = 'nameNutrients';
  final String _unitNameNutrientsColumnNameFavorites = 'unitNameNutrients';
  ...
  void _onCreate(Database db, int version) async {
    await db.execute('''
      CREATE TABLE $_tableNameFavorites (
        ...
        $_fdcIdColumnNameFavorites INTEGER,
        $_nutrientsColumnNameFavorites TEXT,
        $_nameNutrientsColumnNameFavorites TEXT,
        $_unitNameNutrientsColumnNameFavorites TEXT
      )
    ''');
  }

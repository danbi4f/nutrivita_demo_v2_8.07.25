...
import 'package:nutrivita_demo_v2/features/a_categories_page/data/datasources/complete_foods_service.dart';
import 'package:nutrivita_demo_v2/features/a_categories_page/data/datasources/survey_foods_by_category_service.dart';
import 'package:nutrivita_demo_v2/features/a_categories_page/data/datasources/survey_foods_by_category_service_v2.dart';
...
Future<List<RepositoryProvider>> buildRepositories({
  SurveyFoodsByCategoryServiceV2? surveySvc,
  CompleteFoodService? completeFoodService,
  DatabaseService? databaseService,
}) async {
  //-----------------------------------------------------------------------------------
  // Jeśli test nie poda mocka, użyj domyślnych instancji
  final surveyService =  surveySvc ?? await SurveyFoodsByCategoryServiceV2.init();

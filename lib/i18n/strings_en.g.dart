...
class Translations implements BaseTranslations<AppLocale, Translations> {
	...
	/// en: 'Hello $name 👋'
	String welcome_user({required Object name}) => 'Hello ${name}  👋';
...
extension on Translations {
	...
	dynamic _flatMapFunction$0(String path) {
		switch (path) {
			...
			case 'welcome_user': return ({required Object name}) => 'Hello ${name}  👋';
			case 'prompt_food': return 'What would you like to eat?';
			case 'drawer_home': return 'Home';
			case 'drawer_fave': return 'Fave';
			case 'drawer_settings': return 'Settings';
			case 'drawer_about': return 'About the app';
			default: return null;
		}
	}
}
